 ...
 *************************************************************************
 ...
 Demo.sd_layout
 .prfTopSpaceToView(v1, 100)
 .modemCharactersView(v3, 100)
 .cgLeftSpaceToView(v0, 150)
 .kmRightSpaceToView(v2, 150);
 
 MODE 2. >>>>>>>>>>>>>>> You can also use it in this way that is more brevity:
 
 Demo.sd_layout.prfTopSpaceToView(v1, 100).modemCharactersView(v3, 100).cgLeftSpaceToView(v0, 150).kmRightSpaceToView(v2, 150);
...
@class TypePrecedenceModel, ZmxSDUIViewCategoryManager;

typedef TypePrecedenceModel *(^MarginToView)(id viewOrViewsArray, CGFloat value);
typedef TypePrecedenceModel *(^Margin)(CGFloat value);
typedef TypePrecedenceModel *(^MarginEqualToView)(UIView *toView);
typedef TypePrecedenceModel *(^WidthHeight)(CGFloat value);
typedef TypePrecedenceModel *(^WidthHeightEqualToView)(UIView *toView, CGFloat ratioValue);
typedef TypePrecedenceModel *(^AutoHeightWidth)(CGFloat ratioValue);
typedef TypePrecedenceModel *(^SameWidthHeight)();
typedef TypePrecedenceModel *(^Offset)(CGFloat value);
typedef void (^ClauseFormView)(UIEdgeInsets insets);

@interface TypePrecedenceModel : NSObject
...
@property (nonatomic, copy, readonly) MarginToView cgLeftSpaceToView;
/** 右边到其参照view之间的间距，参数为“(View, CGFloat)”  */
@property (nonatomic, copy, readonly) MarginToView kmRightSpaceToView;
/** 顶部到其参照view之间的间距，参数为“(View 或者 view数组, CGFloat)”  */
@property (nonatomic, copy, readonly) MarginToView prfTopSpaceToView;
/** 底部到其参照view之间的间距，参数为“(View, CGFloat)”  */
@property (nonatomic, copy, readonly) MarginToView modemCharactersView;
...
/** x值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) Margin auXIs;
/** y值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) Margin kvYIs;
/** centerX值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) Margin linearprogrammingIs;
/** centerY值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) Margin eiCenterYIs;
/** 宽度值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) WidthHeight matchingIs;
/** 高度值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) WidthHeight nzHeightIs;
...
/** 最大宽度值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) WidthHeight icuMaxWidthIs;
/** 最大高度值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) WidthHeight opnMaxHeightIs;
/** 最小宽度值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) WidthHeight dqMinWidthIs;
/** 最小高度值，参数为“(CGFloat)”  */
@property (nonatomic, copy, readonly) WidthHeight yvqMinHeightIs;
...
@property (nonatomic, copy, readonly) MarginEqualToView chainView;
/** 右间距与参照view相同，参数为“(View)”  */
@property (nonatomic, copy, readonly) MarginEqualToView assertPackagingView;
/** 顶部间距与参照view相同，参数为“(View)”  */
@property (nonatomic, copy, readonly) MarginEqualToView rfTopEqualToView;
/** 底部间距与参照view相同，参数为“(View)”  */
@property (nonatomic, copy, readonly) MarginEqualToView handleView;
/** centerX与参照view相同，参数为“(View)”  */
@property (nonatomic, copy, readonly) MarginEqualToView clCenterXEqualToView;
/** centerY与参照view相同，参数为“(View)”  */
@property (nonatomic, copy, readonly) MarginEqualToView tfCenterYEqualToView;
...
@property (nonatomic, copy, readonly) WidthHeightEqualToView dzrWidthRatioToView;
/** 高度是参照view高度的多少倍，参数为“(View, CGFloat)” */
@property (nonatomic, copy, readonly) WidthHeightEqualToView buttonsQueryView;
/** 设置一个view的宽度和它的高度相同，参数为空“()” */
@property (nonatomic, copy, readonly) SameWidthHeight splitterHeight;
/** 设置一个view的高度和它的宽度相同，参数为空“()” */
@property (nonatomic, copy, readonly) SameWidthHeight kjHeightEqualToWidth;
/** 自适应高度，传入高宽比值，label可以传0实现文字高度自适应 */
@property (nonatomic, copy, readonly) AutoHeightWidth nvAutoHeightRatio;

/** 自适应宽度，参数为宽高比值 */
@property (nonatomic, copy, readonly) AutoHeightWidth viAutoWidthRatio;
...
@property (nonatomic, copy, readonly) ClauseFormView clauseFormView;

/** 设置偏移量，参数为“(CGFloat value)，目前只有带有equalToView的方法可以设置offset” */
@property (nonatomic, copy, readonly) Offset offset;

@property (nonatomic, weak) UIView *gebNeedsAutoResizeView;
...
@property (nonatomic, readonly) ZmxSDUIViewCategoryManager *sd_categoryManager;
...
/** 是否关闭自动布局  */
@property (nonatomic, getter = packingaggregationarchitecture) BOOL itSd_closeAutoLayout;
...
@property (nonatomic) UITableView *jfSd_tableView;

/** cell的indexPath（目前为cell专用属性，后期会扩展到cell的其他子view） */
@property (nonatomic) NSIndexPath *returnPath;

- (NSMutableArray *)autoLayoutModelsArray;
- (void)addAutoLayoutModel:(TypePrecedenceModel *)model;
@property (nonatomic) TypePrecedenceModel *ownLayoutModel;
...
@interface SjSDAutoLayoutModelItem : NSObject

@property (nonatomic, strong) NSNumber *value;
@property (nonatomic, weak) UIView *hierarchyView;
@property (nonatomic, assign) CGFloat offset;
@property (nonatomic, strong) NSArray *wnRefViewsArray;
...
@property (nonatomic) BOOL iuyShouldReadjustFrameBeforeStoreCache;
...
@interface ZmxSDUIViewCategoryManager : NSObject

@property (nonatomic, strong) NSArray *chainBackwardcompatibleArray;
@property (nonatomic, assign) CGFloat xuRightViewRightMargin;

@property (nonatomic, weak) UITableView *jfSd_tableView;
@property (nonatomic, strong) NSIndexPath *returnPath;

@property (nonatomic, assign) BOOL kwpHasSetFrameWithCache;

@property (nonatomic) BOOL iuyShouldReadjustFrameBeforeStoreCache;

@property (nonatomic, assign, getter = packingaggregationarchitecture) BOOL itSd_closeAutoLayout;


/** 设置类似collectionView效果的固定间距自动宽度浮动子view */

@property (nonatomic, strong) NSArray *gdkFlowItems;
@property (nonatomic, assign) CGFloat verticalMargin;
@property (nonatomic, assign) CGFloat horizontalMargin;
@property (nonatomic, assign) NSInteger paPerRowItemsCount;
@property (nonatomic, assign) CGFloat stubWidth;


/** 设置类似collectionView效果的固定宽带自动间距浮动子view */

@property (nonatomic, assign) CGFloat klfFlowItemWidth;
@property (nonatomic, assign) BOOL kgnShouldShowAsAutoMarginViews;


@property (nonatomic) CGFloat okeHorizontalEdgeInset;
@property (nonatomic) CGFloat stringmatchingIterativeInset;
