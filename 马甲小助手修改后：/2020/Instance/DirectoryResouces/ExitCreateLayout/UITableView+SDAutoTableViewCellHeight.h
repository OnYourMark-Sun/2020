...
@class NpSDCellAutoHeightManager;
...
@property (nonatomic, strong) NpSDCellAutoHeightManager *cellAutoHeightManager;
 ...
 * drContentViewWidth   : cell的contentView的宽度
 */
 ...
 * cellClass          : 当前的indexPath对应的cell的class
 * drContentViewWidth   : cell的contentView的宽度
 * cpCellDataSetting    : 设置cell数据的block
 */
- (CGFloat)cellHeightForIndexPath:(NSIndexPath *)indexPath cellClass:(Class)cellClass cellContentViewWidth:(CGFloat)width cpCellDataSetting:(AutoCellHeightDataSettingBlock)cpCellDataSetting;
...
@property (nonatomic, copy) AutoCellHeightDataSettingBlock cpCellDataSetting;
...
@interface NpSDCellAutoHeightManager : NSObject

@property (nonatomic, assign) BOOL lhShouldKeepHeightCacheWhenReloadingData;

@property (nonatomic, assign) CGFloat drContentViewWidth;

@property (nonatomic, assign) Class cellClass;

@property (nonatomic, assign) CGFloat gwCellHeight;

@property (nonatomic, strong) UITableViewCell *aoiModelCell;

@property (nonatomic, strong) NSMutableDictionary *containerQualifierDict;
